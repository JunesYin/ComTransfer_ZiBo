...
#define IsReceiveString  0     //采用何种方式接收：ReceiveString 1多字符串接收（对应响应函数为WM_COMM_RXSTR），ReceiveString 0一个字符一个字符接收（对应响应函数为WM_COMM_RXCHAR）
class CSerialPort
{				 
public:
	...
	UINT		GetPort();	// 获取当前监听的COM口。 Add by Junes 2017-04-10
